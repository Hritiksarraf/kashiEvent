    ...
    <footer className="bg-black/95">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div  className="mb-10 md:mb-0">
            ...
            <div  className="text-sm flex mt-4 justify-end sm:mt-0 text-gray-200 flex-col ">
              <p className="text-lg text-blue-400 font-medium h  lg:mt- w[screen] lg:pr-16 lg:w-[35vw]"><span className="text-red-600">Kashi Event & Caterers</span>From elegant weddings and lively pool parties to corporate gatherings and birthday celebrations, we create unforgettable experiences with meticulous planning, stunning decor, and exceptional service. Trust us to bring your vision to life for any occasion!</p>
        ...
        <div  className="sm:flex sm:items-center sm:justify-between">
          <span  className="text-lg text-gray-200 sm:text-center text-center m-auto ">
