...
export default function Product(props) {
            ...
            <div className='grid lg:grid-cols-2 items-center justify-items-center '>
                <div className='order-2 pb-10 lg:pb-0 lg:order-1 flex text-white flex-col justify-center items-center'>
                    ...
                    <div className='flex justify-between width-screen'>
                        <div className='px-8 '>
                        <Link to='/contact' className={`bg-gradient-to-r  to-[#aa9c66] from-[#584D3C] py-2 px-6  text-black rounded-2xl  text-lg`}>Contact</Link>
                        </div>
                        <div className='px-8'>
  ...
  <img src={props.img} class="md:w-[50vw] object-cover md:h-[60vh]  rounded-3xl " />
